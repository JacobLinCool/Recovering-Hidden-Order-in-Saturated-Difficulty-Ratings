#!/usr/bin/env python
"""Generate the public artifact from canonical evidence."""
    ...
    sorted(
        {
            ...
            "paper/manuscript/figures/hidden_order_protocol.tex",
            "pyproject.toml",
            "uv.lock",
        }
    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--paper-evidence",
        type=Path,
        default=Path("paper/manuscript/generated/paper_evidence.json"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("paper/manuscript/artifact/public"),
    )
...
def main() -> None:
    ...
    release_docs = Path("paper/manuscript/artifact/public")
