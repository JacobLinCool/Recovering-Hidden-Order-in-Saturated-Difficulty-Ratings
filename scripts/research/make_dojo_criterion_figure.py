#!/usr/bin/env python
"""Render the Dan-i Dojo external criterion for the paper."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary",
        type=Path,
        default=Path("paper/manuscript/artifact/public/dojo_criterion_summary.jsonl"),
    )
    parser.add_argument(
        "--matched",
        type=Path,
        default=Path("paper/manuscript/artifact/public/dojo_public_matches.jsonl"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("paper/manuscript/generated/dojo_criterion.pdf"),
    )
